...
EOF;
        ...
        public function testObjectsSupportDisabledWithExceptions() {
            $this->parser->parse('foo: !!php/object:O:30:"Symfony\Tests\Component\Yaml\B":1:{s:1:"b";s:3:"foo";}',
                                 true,
                                 false);
        }
        ...
        public function testNonUtf8Exception() {
            ...
            foreach ($yamls as $yaml) {
                try {
                    ...
                    $this->assertInstanceOf('Symfony\Component\Yaml\Exception\ParseException',
                                            $e,
